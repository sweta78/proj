...
<map name="Map" id="Map">
 ...
 <button  id="b2"><area shape="rect" coords="250,61,388,96" href="login1.php" alt=""></button>
  ...
  <div id="user" class="background">
        ...
        <form method="post" id="f1" action="login_action1.php">
            <table class="frm">
              <tr>
        ...
        <form method="post" id="f1" action="<?php echo $_SERVER["PHP_SELF"];?>">
            <table class="frm">
              <tr>
                 <td style="font-size:14px; font-weight:bold; width:100px;">User Name:</td>
